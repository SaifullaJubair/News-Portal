                ...
                <div key={news?._id} className="border rounded p-1">
                  ...
                  >
                    ...
                    <div className="col-span-2 ">
                      <p className="font-semibold text-pTextColor  text-[12px] line-clamp-2 group-hover:text-pHoverTextColor">
                        {news?.heading}
                      </p>
                      <p className="text-[11px] flex gap-2 items-center text-gray-700 my-1">
                        <FaRegClock />
