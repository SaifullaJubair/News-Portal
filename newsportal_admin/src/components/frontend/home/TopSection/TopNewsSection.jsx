            ...
            {topNews?.data?.slice(0, 1).map((news, index) => (
              <div key={index} className="relative col-span-1 ">
                ...
                >
                  ...
                  <h1 className="font-bold line-clamp-2 my-2 ml-1  w-full  text-pTextColor group-hover:text-primaryLightColor">
                    {news?.heading}
                  </h1>
                  <hr className="mb-3" />
                </Link>
                ...
                >
                  <div className="group  duration-200  grid grid-cols-7 gap-1.5">
                    ...
                    <div className="col-span-4">
                      <h1 className=" font-extrabold  sm:line-clamp-3 hover:text-pHoverTextColor duration-150  md:max-w-lg w-full  text-gray-900 group-hover:text-pHoverTextColor">
                        {news?.heading}
                      </h1>
                    </div>
                  </div>
                  <p
                    className="line-clamp-1 mt-1 text-xs text-pTextDetailsColor hidden"
