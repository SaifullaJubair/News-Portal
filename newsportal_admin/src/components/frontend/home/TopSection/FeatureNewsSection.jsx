      ...
      {featureNews?.data?.length > 0 && (
        <div className="ml-1">
          <div className=" grid grid-cols-1  sm:grid-cols-5 gap-2 border-b ">
            <Link
              to={`/${featureNews?.data?.[0]?.category_info?.category_slug}/${featureNews?.data?.[0]?._id}`}
                ...
                >
                  <div className="group  duration-200 mb-3 grid grid-cols-7 gap-1.5">
                    ...
                    <div className="col-span-4">
                      <h1 className=" font-extrabold  sm:line-clamp-3 hover:text-pHoverTextColor duration-150 text-base md:max-w-lg w-full  text-gray-900 group-hover:text-pHoverTextColor">
                        {news?.heading}
                      </h1>
                    </div>
                  </div>
            ...
            {featureNews?.data?.slice(3, 9)?.map((news, index) => (
              <>
                ...
                >
                  ...
                  <h1 className="font-extrabold line-clamp-2  hover:text-pHoverTextColor duration-150  md:max-w-lg w-full my-1.5 text-gray-900 group-hover:text-pHoverTextColor">
                    {news?.heading}
                  </h1>
                  <div
