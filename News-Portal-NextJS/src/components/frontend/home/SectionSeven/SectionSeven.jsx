...
const SectionSeven = ({ newsData }) => {
  const layer3 = "/assets/image/layer3.jpg";
        ...
        <div className="flex items-center justify-between  py-2 border-b-4 border-white  ">
          ...
          >
            <Image
              ...
              height={40}
              width={40}
              className="  bg-white rounded-sm group-hover:text-pHoverTextColor duration-100"
            />

            <p className="text-white group-hover:text-pHoverTextColor duration-100 text-lg sm:text-xl">
              {" "}
        ...
        <div className="mt-4 relative">
          ...
          >
            {newsData?.news?.slice(0, 10)?.map((item, index) => (
              ...
              >
                <Link href={`/${categorySlug}/${item?._id}`}>
                  <img
                    src={item?.main_image}
                  ...
                  <div className="mt-2">
                    <p
                      className="font-semibold  text-pTextColor text-lg md:text-base group-hover:text-pHoverTextColor"
                      style={{
                        overflow: "hidden",
                        display: "-webkit-box",
                        WebkitLineClamp: "1",
