      ...
      <div className="grid grid-cols-1  md:grid-cols-9 gap-2 pt-6 pb-3 ">
        ...
        <div className="cursor-pointer  hover:opacity-90 col-span-1 md:col-span-3 px-2 md:flex items-center justify-between gap-2 group  ">
          <Link href={`/${categorySlug}/${newsData?.news[2]?._id}`}>
            ...
            <div className="p-2  ">
              <p className="font-bold mb-2 text-gray-900 my-1.5 text-lg lg:text-[20px]  group-hover:text-pHoverTextColor hover:text-pHoverTextColor line-clamp-2 sm:line-clamp-3">
        ...
        <div className="flex md:flex-col   justify-between gap-4 md:gap-1 md:col-span-2  px-2 tracking-wider divide-y  md:border-x border-b md:border-b-0">
          {newsData?.news?.slice(3, 5)?.map((item, index) => (
            ...
            >
              ...
              <div className="my-3">
                <p
                  className="font-semibold  text-pTextColor  text-sm  md:text-base   lg:text-base group-hover:text-pHoverTextColor hover:text-pHoverTextColor"
                  style={{
                    overflow: "hidden",
                    display: "-webkit-box",
                    WebkitLineClamp: "2",
