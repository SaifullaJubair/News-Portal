            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 pt-4 gap-4">
                <div className="col-span-1 sm:col-span-2 ">
                  <Link
                    to={`/${categoryHeadData?.[0]?.category_id?.category_slug}/${categoryHeadData?.[0]?._id}`}
                  >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 md:col-span-2 gap-4">
                  {categoryHeadData?.slice(1, 5).map((news) => (
                    ...
                    >
                      <Link
                        to={`/${news?.category_id?.category_slug}/${news?._id}`}
                      >
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 my-6">
                  {item?.news?.slice(0, 12).map((newsItem) => (
                    ...
                    >
                      ...
                      />
                      <div className="py-2">
                        <p className=" font-semibold text-pTextColor px-2 text-[13px] sm:text-[14px] line-clamp-2 group-hover:text-pHoverTextColor ">
                          {newsItem?.heading}
                        </p>
                        <p
                          className=" mt-1 text-pTextDetailsColor px-2 text-[12px]  line-clamp-2 group-hover:text-pHoverTextColor "
                          dangerouslySetInnerHTML={{
