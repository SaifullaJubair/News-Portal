        ...
        <div className="md:col-span-3 mt-6">
          {newsData?.slice(0, 2).map((item, index) => (
            ...
            >
              ...
              />
              <div className="p-2">
                <p className="font-semibold pb-3 text-pTextColor text-lg  group-hover:text-pHoverTextColor hover:text-pHoverTextColor line-clamp-2">
                  {item?.heading}
                </p>
                <p
        ...
        <div className="md:col-span-2">
          {newsData?.slice(2, 5)?.map((item, index) => (
            ...
            >
              ...
              <div className="py-1">
                <p
                  className="font-semibold text-pTextColor pt-2 text-base group-hover:text-pHoverTextColor hover:text-pHoverTextColor"
                  style={{
                    overflow: "hidden",
                    display: "-webkit-box",
                    WebkitLineClamp: "2",
