...
const UpdateStaff = ({
  ...
  const [description, setDescription] = useState(
    updateModalValue?.user_description
  );
  ...
  const handleDataPost = async (data) => {
    setLoading(true);
    let user_image = updateModalValue?.user_image;
        ...
        <form onSubmit={handleSubmit(handleDataPost)}>
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="mt-4">
              ...
              <input
                ...
                defaultValue={updateModalValue?.user_designation}
                id="user_designation"
                type="text"
                className="block w-full px-2 py-1.5 text-gray-700 bg-white border border-gray-200 rounded-xl"
              />
            ...
            <div className="mt-4">
              ...
              <input
                ...
                id="user_id"
                type="number"
                defaultValue={updateModalValue?.user_id}
                className="block w-full px-2 py-1.5 text-gray-700 bg-white border border-gray-200 rounded-xl"
              />
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="mt-4">
                ...
                <input
                  ...
                  defaultValue={updateModalValue?.reference_number}
                  id="reference_number"
                  type="text"
                  className="block w-full px-2 py-1.5 text-gray-700 bg-white border border-gray-200 rounded-xl"
                />
          ...
          <div className="relative my-4">
            {imagePreview && (
              <>
                <Image width={1000}
                  height={100} src={imagePreview} alt="Preview" />
                <button
                  type="button"
            ...
            />
            {errors.user_image && (
              <p className="text-red-600">{errors.user_image?.message}</p>
            )}
          </div>
