  ...
  return (
    <div className="max-w-[1400px] w-[95%] mx-auto">
      ...
      <div className="grid grid-cols-1  md:grid-cols-3 lg:grid-cols-4 gap-3 lg:gap-5 py-6 ">
            ...
            {newsData?.news?.slice(0, 3)?.map((item, index) => (
              ...
              >
                ...
                <div className=" col-span-3 space-y-1.5">
                  <p className="font-bold  text-gray-900 text-lg   line-clamp-2 group-hover:text-pHoverTextColor hover:text-pHoverTextColor">
                    {" "}
                    {item?.heading}
                  </p>
                  <p
        ...
        <div className="col-span-2 sm:col-span-1 px-2 mt-1  ">
        ...
        {adsData && (
          <div className="md:hidden lg:block lg:h-full mx-auto">
            <a target="_blank" rel="noreferrer" href={`${adsData?.ads_link}`}>
              <img
                src={adsData?.ads_image}
                className="h-52 w-full sm:h-auto sm:w-auto"
                alt=""
              />
            </a>
          </div>
