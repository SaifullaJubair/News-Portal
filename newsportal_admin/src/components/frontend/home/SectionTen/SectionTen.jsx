      ...
      <div className="grid grid-cols-2  md:grid-cols-9 gap-2 py-6  ">
        ...
        <div className="cursor-pointer  hover:opacity-90 col-span-2 md:col-span-3 px-2 md:border-x mt-3 md:flex flex-col  group ">
          <Link to={`/${categorySlug}/${newsData?.news[2]?._id}`}>
            ...
            <div className="p-2  ">
              <p className="font-bold mb-2 text-gray-900 my-1.5 text-[16px] lg:text-[22px]  group-hover:text-pHoverTextColor hover:text-pHoverTextColor line-clamp-2 sm:line-clamp-3">
