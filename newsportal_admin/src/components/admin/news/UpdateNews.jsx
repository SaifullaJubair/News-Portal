  ...
  const handleDataPost = async (data) => {
    ...
    if (data?.writer_image?.length > 0) {
      ...
      if (imageUpload[2] == true) {
        ...
        previous_image_key = updateModalValue?.writer_image_key;
      } else {
    ...
    if (sendData?.division && sendData?.district === undefined) {
      toast.error("Select your division and district", {
        autoClose: 1000,
      });
      setLoading(false);
      return;
