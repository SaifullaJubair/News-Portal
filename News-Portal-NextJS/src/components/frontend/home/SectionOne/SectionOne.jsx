  ...
  return (
    <div className="max-w-[1400px] w-[95%] mx-auto">
      <div className="flex items-center justify-between">
        <Link
          href={`/${newsData?.categoryDetails?.category_slug}`}
        ...
        >
          ...
          />
          <p className="text-lg sm:text-xl">{newsData?.categoryDetails?.category_name}</p>
        </Link>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 sm:gap-2 pt-6 tracking-wide">
        <div className="px-2 border-r-0 sm:border-r group mt-2">
          ...
          >
            ...
            />
            <div>
              <p className="text-pHeadingTextColor text-base group-hover:text-pHoverTextColor duration-150 line-clamp-2">
        ...
        <div className="flex flex-col gap-3 px-2 border-r-0 sm:border-r h-full divide-y">
          {newsData?.news?.slice(2, 6).map((item, index) => (
            <Link
              href={`/${newsData?.categoryDetails?.category_slug}/${item?._id}`}
            ...
            >
              ...
              <div className="w-[65%]">
                <p
                  className="text-pHeadingTextColor text-lg md:text-base xl:text-base group-hover:text-pHoverTextColor"
                  style={{
                    overflow: "hidden",
                    display: "-webkit-box",
                    WebkitLineClamp: "2",
