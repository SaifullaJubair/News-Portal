...
const CategoryJoripSection = () => {
  ...
  const jorip_id = queryParams.get("jorip_id");
            ...
            <div key={jorip?._id} className="group border rounded-md">
              ...
              >
                ...
                <div className="p-2">
                  ...
                  <p className="font-semibold mb-2 text-pHeadingTextColor text-[16px] group-hover:text-pHoverTextColor duration-150 line-clamp">
