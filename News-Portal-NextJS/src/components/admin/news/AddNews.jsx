...
const RxCross1 = dynamic(() => import("react-icons/rx").then((mod) => mod.RxCross1), {
...
const AddNews = ({
  ...
  // Define the toolbar options, including color options
const modules = {
  toolbar: [
    [{ header: [1, 2, 3, 4, 5, 6] }],
    [{ font: [] }],
...
const formats = [
  ...
  const handleCancelMetaImage = () => {
    setMetaImagePreview(null); // Clear image preview
    // Clear input value (optional)
        ...
        >
          ...
          <div className="relative">
            ...
            {imagePreview &&
              <>
                <Image width={1000}
                  height={200} src={imagePreview} alt="Preview" />
                <button
                  type="button"
      ...
      />
          ...
          <div className="relative">
            ...
            {writerImagePreview &&
              <>
                <Image width={1000}
                  height={200} src={writerImagePreview} alt="Preview" />
                <button
                  type="button"
                  className="absolute top-2 right-2 bg-red-500 text-white rounded-full p-1 px-2 hover:bg-red-600"
          ...
          <div className="relative">
            ...
            {metaImagePreview &&
              <>
                <Image width={1000}
                  height={200} src={metaImagePreview} alt="Preview" />
                <button
                  type="button"
                  className="absolute top-2 right-2 bg-red-500 text-white rounded-full p-1 px-2 hover:bg-red-600"
