...
import { ConvertToUnicode, ConvertToASCII } from "bijoy-to-unicode-bengali-conversion";
    ...
    return (
        <div className="tracking-wide">
            <div className="max-w-[1400px] w-[95%] mx-auto bg-[#fbf9f9]  p-8">
                <div className="mt-8">
                    <label htmlFor="unicode" className="block font-bold">ইউনিকোড কি-বোর্ডের লেখা এখানে পেস্ট করুন: </label>
                    <textarea
                        type="text"
                        name="unicode"
                        id="unicode"
                ...
                <div className="mt-8 flex items-center justify-center gap-6 flex-wrap">
                    <button type="button" className="bg-primaryLightColor text-white px-4 py-2 font-semibold" onClick={handleUnicodeToBijoy}> ইউনিকোড টু বিজয় </button>
                    <button type="button" className="bg-irisBlueColor text-white px-4 py-2 font-semibold" onClick={handleBijoyToUnicode}> বিজয় টু ইউনিকোড </button>
                    <button type="button" className="bg-red-500 text-white px-4 py-2 font-semibold" onClick={() => {
                        setBijoy("")
                        setUnicode("")
                    }}> মুছে ফেলুন </button>
                </div>
                <div className="mt-8">
                    <label htmlFor="bijoy" className="block font-bold">বিজয় কি-বোর্ডের লেখা এখানে পেস্ট করুন:</label>
                    <textarea
                        type="text"
                        name="bijoy"
                        id="bijoy"
